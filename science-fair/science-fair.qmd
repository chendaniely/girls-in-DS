...
::: {style="text-align: center;"}
<img src="https://images.tpointtech.com/tutorial/machine-learning/images/train-and-test-datasets-in-machine-learning.png" width="400"/> <br> <sub style="font-size: 0.3em;"><https://www.tpointtech.com/train-and-test-datasets-in-machine-learning></sub>
:::
...
<sub><https://www.financialexpress.com/></sub>
...
## UBC Girls in Data Science Camp{.hidden}
...
## Data Science Major at UBC

- "Data science is the process of generating insight from data through reproducible and transparent processes."
- First cohort of students began in fall 2025! 
- Jointly offered by Statistics + Computer Science 
- Possible career paths include: Data Scientist, Data Analyst, ML Engineer etc.
